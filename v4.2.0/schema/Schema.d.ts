...
export declare class Schema<const ROOT extends Schema.Property | Schema.MultiProperty> {
     ...
     */
    processData(data: this['infer'], partial?: boolean): this['infer'];
    processData(data: this['inferToProcess'], partial?: boolean): this['infer'];
    /**
     ...
     */
    processUnknown(data: any, partial?: boolean): this['infer'];
    /**
    ...
    protected validatePropertyMath(data: any, prop: Schema.Property | Schema.MultiProperty, checkDefaults?: boolean): boolean;
    /**
     * process a property
     * @param data the data to process
     ...
     * @throws schemaError if the data is not valid
     */
    protected validateArray(value: any, prop: Schema.Definition.Array, key: string): null | undefined;
    /**
    ...
    */
    ...
    static fromObject<const T extends Schema.PropertyMap, const A extends Schema.Property | Schema.MultiProperty | boolean | undefined>(obj: T, allowAdditionalProperties: A): Schema.Utils.FromObject<T, A>;
}
export declare namespace Schema {
    ...
    namespace Definition {
         ...
         */
        interface MultiProperty<T extends Property = Property> extends Omit<Base<keyof TypeMap>, 'type'> {
            type: 'union';
            union: T[];
    ...
    namespace Infer {
        namespace Support {
             ...
             */
            type AdditionalProps<P extends Definition.Object, M extends Mode> = P['allowAdditionalProperties'] extends true ? {
                [key: string]: any;
        ...
        } ? E : string) : P extends Definition.Number ? number : P extends Definition.Boolean ? boolean : P extends Definition.Object ? (P['properties'] extends PropertyMap ? Mapping.Resolve<P['properties'], M> : {}) & Support.AdditionalProps<P, M> : P extends Definition.Array ? GetItemType<P, M>[] : never);
        /**
         ...
         */
        export type GetItemType<P extends Definition.Array, M extends Mode = 'complete'> = (P['items'] extends Property ? GetPropertyType<P['items'], M> : GetBaseType<P['items'], M>);
        /**
        ...
        export type Core<P extends Property | MultiProperty, M extends Mode> = (P extends Definition.Object ? (P['properties'] extends PropertyMap ? Mapping.Resolve<P['properties'], M> : {}) & Support.AdditionalProps<P, M> : Wrap<P, M>);
    ...
    namespace Utils {
        ...
        type AnyChildHasDefault<P extends PropertyMap> = {
            [K in keyof P]: HasDefault<P[K]> extends true ? K : never;
        }[keyof P] extends never ? false : true;
        type RequiredChildMissingDefault<P extends PropertyMap> = {
            [K in keyof P]: Utils.IsRequired<P[K]> extends true ? (HasDefault<P[K]> extends true ? never : K) : never;
        }[keyof P] extends never ? false : true;
        type HasDefaultEx<T> = T extends {
            default: any;
        } ? true : T extends {
            type: 'union';
            union: infer U extends Property[];
        } ? (U[number] extends infer M ? (HasDefault<M & Property> extends true ? true : false) : false) : T extends {
            type: 'object';
            properties: infer P;
        } ? (P extends PropertyMap ? (AnyChildHasDefault<P> extends true ? (RequiredChildMissingDefault<P> extends true ? false : true) : false) : false) : false;
        type HasDefault<T> = HasDefaultEx<T>;
        ...
        type FromObject<T extends PropertyMap, A extends Schema.Property | Schema.MultiProperty | boolean | undefined> = Schema<{
            type: 'object';
            properties: T;
